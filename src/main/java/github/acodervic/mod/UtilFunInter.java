...
import github.acodervic.mod.javafx.FxAppThreadUtil;
...
public interface UtilFunInter extends Serializable {
     ...
     */
    public default void fxRunLaterSync(Runnable run,Long timeoutMillis) {
        FxAppThreadUtil.fxRunLaterSync(run, timeoutMillis);
    }
     ...
     * @param run
     */
    public   default void fxRunLaterSync(Runnable run) {
     ...
     * @param run
     */
    public default void fxRunLater(Runnable run) {
        FxAppThreadUtil.fxRunLater(run);
    }
